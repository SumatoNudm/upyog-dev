...
/**
 * Request object for creating Budget Register
 */
@ApiModel(description = "Request object for creating Budget Register")
@Validated
...
public class BudgetRegisterRequest   {
        ...
        @Valid
        private List<BudgetRegister> budgetRegister = new ArrayList<>();


        public BudgetRegisterRequest addBudgetRegisterItem(BudgetRegister budgetRegisterItem) {
